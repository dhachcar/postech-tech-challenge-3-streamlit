    ...
    def render(self):
        with self.tab:
            ...
            st.markdown(
                ...
                O **:blue[Dataproc]** opera sob a infraestrutura do GCP, fornecendo um ambiente gerenciado e escalável para executar clusters do **:blue[Apache Spark]** e **:blue[Hadoop]**. No entanto, optamos por não utilizar o **:blue[Dataproc]** neste cenário específico devido à simplicidade e acessibilidade do **:blue[Google Colab]** para fins de demonstração ou análise exploratória, sem a necessidade de configurar e gerenciar um ambiente de cluster separado. Esta escolha permite uma configuração rápida e fácil para iniciar a análise de dados com o **:blue[Apache Spark]**, aproveitando a infraestrutura gratuita fornecida pelo **:blue[Google Colab]**.
            """
            )
